...
<Components.Chakra.SimpleGrid columns={[1, null, 2]} spacing='40px'>
    <img style={{
        borderRadius:20,
        width: "100%"
    }} src="/images/side-projects/product-management/productCreate.png" alt="product-create?"/>
...
This is project create feature. The project list feature displays all your created projects for easy tracking and management.